var readUrl   = 'http://localhost/talkify/index.php/reps/read',
    updateUrl = 'http://localhost/talkify/index.php/reps/update',
    delUrl    = 'http://localhost/talkify/index.php/reps/delete',
    delHref,
    updateHref,
    updateId;
...
$( function() {
    ...
    $( '#records' ).delegate( 'a.updateBtn', 'click', function() {
        ...
        $.ajax({
            url: 'index.php/reps/getById/' + updateId,
            dataType: 'json',
