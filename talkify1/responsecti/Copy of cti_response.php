	   ...
	   {	
		  ...
		  $clientQry = "SELECT client_id,client_username,client_phone FROM clients WHERE cmp_unique_id ='".$cmp_unique_id."' and client_phone='".$customer_num."'";
			...
			// new client insert the client data
				...
				//client_created_via = 2 meaning created from telephone
			 $insertClient = "insert into clients (client_username,client_password,client_phone,client_creation_date,client_created_via,client_updated_flag,cmp_unique_id) values('".$customer_num."','password','".$customer_num."','".$client_creation_date."',2,'N','".$cmp_unique_id."')";		
