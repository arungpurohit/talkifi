                ...
                for (var h = 0; h < l; ) {
                    ...
                    if (e) { 
                        ...
                        if (!bs && j == (sc - 1) && z[h] < y[h]) {
                            el++;
                            $.extend(tempdata, { "axis": h, ch: "more", "abbr": dateFormat.call(cday[h], i18n.xgcalendar.dateformat.fulldayvalue), html:  (y[h] - z[h]) + i18n.xgcalendar.others + i18n.xgcalendar.item, click: "javascript:alert('more event');" });
