...
class Repdashboard extends TalkifiSuper{
	...
	public function __construct(){
		...
		$this->load->model('repdashboard_model');
	...
	/*channle start */
		if($this->input->post('date_from_channel')!='' && $this->input->post('date_to_channel')!=''){
			$date_from_channel  = $this->input->post('date_from_channel');
			$date_to_channel = $this->input->post('date_to_channel');
		}
		else
		{
...
*/		$data["performance_graph"] = $performance_arr_put;
		...
		*/
		...
		$this->renderPage('dashboard/repdashboard',$data);
