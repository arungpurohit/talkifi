...
class Authenticate extends CI_Controller {
	...
	function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				redirect('superadmin/modules_display/', 'refresh');
			}
			else
			{
				...
				redirect('authenticate/login', 'refresh'); //use redirects instead of loading views for compatibility with MY_Controller libraries
			}
		}
		else
		{
			...
			$this->_render_page('auth/superlogin', $this->data);
		}
	}
	...
	function logout()
	{
		...
		//redirect them to the login page
		$this->session->set_flashdata('message', $this->ion_auth->messages());
		redirect('authenticate/superlogin', 'refresh');
	}
	...
	function forgot_password()
	{
		...
		else
		{
			...
			if ($forgotten)
			{
				...
				$to_email = $forgotten['identity'];
				
				$subject = "[Talkifi]  Reset your account password";
				$msg = "<p>Hello  </p>
						 <p>A request was received, hopefully from you, to reset your Talkifi Accounts
						   site password. </p>
						 <p>Please go to this page to reset your password and be able to
						   access the site. </p>";
						
				$msg .= "<p><a href='".base_url()."index.php/reset-pass/".$forgotten['forgotten_password_code']."'>Reset Password Link</a></p>";
						
				$msg .=" <p>Please ignore this message if you did not request to reset your account
						   password.   </p>
						 <p>Thank you,   </p>
						 <p>Talkifi  Accounts site </p>";
