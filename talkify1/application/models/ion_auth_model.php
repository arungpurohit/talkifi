...
class Ion_auth_model extends CI_Model
{
	 ...
	 * @author Mathew
	 **/
	public function register($username, $password, $email, $additional_data = array(), $groups_id ='' )
	{
		...
		$groups_ins_id = $this->db->insert($this->tables['users_groups'], array( 'group_id' => (int)$groups_id, 'user_id' => (int)$id,'cmp_unique_id' => $this->user->cmp_unique_id));
		/*if (!empty($groups))
		{
			//add to groups
...
*/
	 ...
	 * @author Mathew
	 **/
	public function register_new($username, $password, $email, $additional_data = array(), $groups_id ='',$cmp_unique_id='')
	{
		$this->trigger_events('pre_register');
		...
		$groups_ins_id = $this->db->insert($this->tables['users_groups'], array( 'group_id' => (int)$groups_id, 'user_id' => (int)$id,'cmp_unique_id' => $cmp_unique_id));
		/*if (!empty($groups))
		{
			//add to groups
			foreach ($groups as $group)
...
*/
		...
		$datas = array('assign_perm'=>(int)$id,
					'other_leads_view'=>(int)$id);
	
		$this->db->update( 'groups', $datas, array( 'id' => $groups_id,'cmp_unique_id' => $cmp_unique_id ) );	
	...
	public function login($identity, $password, $remember=FALSE)
	{
		...
		$query = $this->db->select($this->identity_column . ', username, email, id, password, active, last_login,cmp_unique_id')
	 ...
	 * @author Ben Edmunds
	 **/
	public function users($cmp_unique_id=NULL,$groups = NULL)
	{
		...
		if($cmp_unique_id!=NULL)
		$this->db->where('users.cmp_unique_id',$cmp_unique_id);
	 ...
	 * @author Ben Edmunds
	 **/
	public function user($cmp_unique_id=NULL,$id = NULL)
	{
	 ...
	 * @author Ben Edmunds
	 **/
	public function get_users_groups($cmp_unique_id,$id=FALSE)
	{
		...
		return $this->db->select($this->tables['users_groups'].'.'.$this->join['groups'].' as id, '.$this->tables['groups'].'.name, '.$this->tables['groups'].'.description')
						...
						->where($this->tables['users_groups'].'.cmp_unique_id', $cmp_unique_id)
						->where($this->tables['groups'].'.cmp_unique_id', $cmp_unique_id)
...
/**
	 ...
	 * @author Ben Edmunds
	 **/
	public function get_users_groups_subbu($id=FALSE)
	{
		$this->trigger_events('get_users_group');
	 ...
	 * @author Ben Edmunds
	 **/
	public function groups($cmp_unique_id,$group_id)
	{
	 ...
	 **/
	public function update($id, $cmp_unique_id=NULL, array $data)
	{
		$this->trigger_events('pre_update_user');

		$user = $this->user($cmp_unique_id,$id)->row();
