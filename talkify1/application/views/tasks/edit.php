...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head>    
    ...
    <link href="cal_css/css/dp.css" rel="stylesheet" />    
    <link href="cal_css/css/dropdown.css" rel="stylesheet" />    
    <link href="cal_css/css/colorselect.css" rel="stylesheet" />   
     
    <script src="cal_js/src/jquery.js" type="text/javascript"></script>    
    <script src="cal_js/src/Plugins/Common.js" type="text/javascript"></script>        
    <script src="cal_js/src/Plugins/jquery.form.js" type="text/javascript"></script>     
    <script src="cal_js/src/Plugins/jquery.validate.js" type="text/javascript"></script>     
    ...
    <script type="text/javascript">
        ...
        $( function() {
            //debugger;
            var DATA_FEED_URL = "index.php/tasks/index";
            var arrT = [];
            var tt = "{0}:{1}";
            for (var i = 0; i < 24; i++) {
