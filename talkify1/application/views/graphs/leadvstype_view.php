...
<div class="cusheader">
	<h1 class="page-title">Graphs: <i>Leads Vs Types Per Representative</i></h1>
</div>
<div class="grid_10">
        ...
        <div class="cusblockdatatable">
			...
			<table border="0" width="100%">
				<tr>
					<th>
						<?php
							echo form_open("graphs/leadvstypegraph", array('id'=> 'type_search', 'name'=>'type_search'));
						?>
					<div class="cusblock">
						<div class="cusblock-heading">
							...
							?>
							<?php 
								echo form_submit('searchtype', 'Get Status'); 
								echo form_close();
							?>
						</div> <!-- end of demo div -->
					</div>
					...
					<td>
						<script type="text/javascript">
							function drawVisualization() {
							  ...
							  var options = {
							  	title: 'Leads Vs Types per Representative ',
							  	vAxis: {title: "Leads"},
							  	hAxis: {title: "Types"},
							  	seriesType: "bars",
							  	series: {5: {type: "line"}}
