...
<div class="cusheader">
	<h1 class="page-title">Graphs: <i>Leads Vs Category Per Representative</i></h1>
</div>
<div class="grid_10">
        ...
        <div class="cusblockdatatable">
			...
			<table border="0" width="100%">
				<tr>
					<th>
						<?php
							echo form_open("graphs/leadvscategorygraph", array('id'=> 'category_search', 'name'=>'category_search'));
						?>
					<div class="cusblock">
						<div class="cusblock-heading">
							...
							?>
							<?php 
								echo form_submit('searchcategory', 'Get category'); 
								echo form_close();
							?>
						</div> <!-- end of demo div -->
					</div>
						<!--<a href="#">Category Vs Leads</a>-->
					</th>
				</tr>
				<tr>
					<td>
						<script type="text/javascript">
							function drawVisualization() {
											...
											foreach($rep_arr_temp as $key1=>$value1){
												if($key1!='' && $value1!=''){
													if($h1==0)
														...
														$other_rows .= ",".$category_graph[$value][$value1]."";
												}
											}
											$h1=1;
											$other_rows .= "],";
							  ...
							  var options = {
							  	title: 'Leads Vs Cateogry Per Representative',
							  	vAxis: {title: "Leads"},
