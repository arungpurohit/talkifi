...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
		...
		slideNextDirection: 'toLeft'
            ...
            var step3_validation = function(){
				...
				$.ajax({
                url: 'index.php/demoregistration/demoregistrations/',
                type: 'POST',
    ...
    <body>
        ...
        <div id="page">
			...
			<?php  echo form_open('demoregistration/');?>
                    ...
                    <div id="slider">
                        <div class="form-step" >
                            ...
                            <div class="row">
                                ...
                                <div class="form-right"><input type="text" id="company_name" name="company_name" class="form-input" /></div>
                                <div class="form-error"></div>
                            </div>
							<div class="row">
                                <div class="form-left">Address *</div>
                                <div class="form-right"><textarea id="address"></textarea></div>
                                <div class="form-error"></div>
                            </div>
                            <div class="row">
                                <div class="form-left">City *</div>
                                <div class="form-right"><input type="text" id="city" name="city" class="form-input" /></div>
                                <div class="form-error"></div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-right">
                                    <select id="state" name="state">
                                        ...
                                        <option value="KA" selected="selected">KARNATAKA</option>
                                        <option value="AP">ANDRA PRADESH</option>
                                        <option value="CH">CHENNI</option>
							 ...
							 <div class="row">
                                ...
                                <div class="form-right"><input type="text" id="zip" name="zip" class="form-input" /></div>
                                <div class="form-error"></div>
                            </div>
							 <div class="row">
                                <div class="form-left">Phone *</div>
                                <div class="form-right"><input type="text" id="phone" name="phone" class="form-input" /></div>
                                <div class="form-error"></div>
                            </div>
                        </div>
                        <div class="form-step" >
